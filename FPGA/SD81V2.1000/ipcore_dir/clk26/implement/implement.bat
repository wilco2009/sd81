...
xst -ifn xst.scr
move clk26_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk26_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk26_exdes.ucf clk26_exdes

echo 'Running map'
map -timing -pr b clk26_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk26_exdes -w routed.ncd routed.v
cd ..
