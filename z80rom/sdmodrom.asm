...
L0000:  OUT     ($FD),A         ; Turn off the NMI generator if this ROM is 
	...
	JP	SD_RESET	; Rather, jump to our routine to reset the MCU
...
L0676:  RES     1,(IY+$01)      ; sv FLAGS  - Signal printer not in use
        LD      A,$C0           ;
...
L0C7A:  DEFB    $03             ; Class-03 - A numeric expression may follow
        ...
        DEFW    SD81RUNCMD      ; Trap RUN command
