...
// puedo eliminar file_name sustituyendolo por tmp?
void cmd_dir_open(){
char s[MAX_FILENAME_LEN];
char file_name[MAX_FILENAME_LEN];
...
void cmd_spare(){
  Serial.print(F("Command not recognized: ")); Serial.println(command_active);
  ToggleClock();
