...
////    result = (uint32_t)((uint64_t)DAC_freq*EP*256)/SYSTEM_FREQ;
  return (uint16_t)coarse*256+fine;
}
...
//  noInterrupts();
  ...
  if (AY_env.period>0){
    ...
    // EP*256/SYSTEM_FREQ
    AY_env.pulses5 = (uint32_t) env_period*35200/35469; 
    AY_env.increment = 5; // AY_env.pulses/(256-MIN_PULSE_HIGH);
...
//void AY_run(void){
//  if (bitRead(AY_reg[R_ENABLE],0)==0) AY_set_tone(AY_CH_A, AYRegToTone(AY_reg[R_FINE_TUNE_A],AY_reg[R_COARSE_TUNE_A])); else AY_reset_tone(AY_CH_A);
//  if (bitRead(AY_reg[R_ENABLE],1)==0) AY_set_tone(AY_CH_B, AYRegToTone(AY_reg[R_FINE_TUNE_B],AY_reg[R_COARSE_TUNE_B])); else AY_reset_tone(AY_CH_B);
//  if (bitRead(AY_reg[R_ENABLE],2)==0) AY_set_tone(AY_CH_C, AYRegToTone(AY_reg[R_FINE_TUNE_C],AY_reg[R_COARSE_TUNE_C])); else AY_reset_tone(AY_CH_C);
//
...
//
//  if (bitRead(AY_reg[R_AMPLITUDE_A],4)==0) AY_set_tone_env(AY_CH_A); else AY_reset_tone_env(AY_CH_A);
//  if (bitRead(AY_reg[R_AMPLITUDE_B],4)==0) AY_set_tone_env(AY_CH_B); else AY_reset_tone_env(AY_CH_B);
//  if (bitRead(AY_reg[R_AMPLITUDE_C],4)==0) AY_set_tone_env(AY_CH_C); else AY_reset_tone_env(AY_CH_C);
//  AY_set_env(AY_reg[R_ENV_SHAPE],AYRegToEnv(AY_reg[R_FINE_EP],AY_reg[R_COARSE_EP]));
//
...
void AY_synthetize(void){
  ...
  if (AY_env.enabled)
    (*AY_env.handle)();
  if (AY_env.level > 15) AY_env.level = 15;// Serial.print("-------"); Serial.println(AY_env.level);
...
void AY_SetReg(uint8_t reg, uint8_t value){
  ...
  //    log_3("---REG %hu = %hu - %hu",reg,AY_reg[reg],value);
    ...
    if (i < snote_len[channel]) {
      switch (s[i]){
        ...
        case '=': modif[channel] = +1;
                  break;
        case '&': // silencios 
                  // AY_config[channel].tone_enabled = false; 
        ...
        case 'V': // volumen por implementar (0..15)
                  ...
                  AY_SetReg(RegVol[channel],vol);
                  // AY_reg[10+channel] = vol;
                  // AY_set_volume(channel, AY_reg[10+channel] & 0x0F);
                  // bitClear(AY_reg[R_ENABLE],4);
                  // AY_env.enabled = false;
                  break;
        case ' ': 
        case 'n': 
        ...
        case 'W': // Envelope (0..7)
                  ...
                  // AY_reg[R_ENV_SHAPE] = AYEnvTypToReg(env);
                  // AY_set_env(AY_reg[R_ENV_SHAPE],AYRegToEnv(AY_reg[R_FINE_EP],AY_reg[R_COARSE_EP]));
                  // AY_config[channel].env_enabled = true;
                  break;
        case 'x': 
        case 'X': // Envelope len(0..65535)
                  ...
                  // AY_reg[R_FINE_EP] = (uint8_t) env_period & 0xff;
                  // AY_reg[R_COARSE_EP] = (uint8_t) (env_period >> 8) & 0xff;
                  // log_3("(X) period = %d R13=%hu R14=%hu R15=%hu", env_period,AY_reg[R_FINE_EP],AY_reg[R_COARSE_EP],AY_reg[R_ENV_SHAPE]);
                  // AY_set_env(AY_reg[R_ENV_SHAPE],AYRegToEnv(AY_reg[R_FINE_EP],AY_reg[R_COARSE_EP]));
                  break;
        case 'u':
        case 'U': AY_SetReg(R_ENABLE, AY_reg[R_ENABLE] | B10000);               
                  // AY_env.enabled = true;
                  // bitSet(AY_reg[R_ENABLE],4);
                  break;
        case '-': // Tied Notes
                  break;
        case ':': // ignored notes :...:
        ...
        case 'B': 
                  ...
                  break; 
//        case 'c': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel],0+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel],0+modif[channel]));
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'd': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel],2+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel],2+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'e': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel],4+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel],4+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'f': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel],5+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel],5+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'g': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel],7+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel],7+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'a': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel],9+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel],9+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'b': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel],11+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel],11+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'C': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel]+1,0+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel]+1,0+modif[channel]));
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'D': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel]+1,2+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel]+1,2+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'E': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel]+1,4+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel]+1,4+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'F': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel]+1,5+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel]+1,5+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'G': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel]+1,7+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel]+1,7+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'A': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel]+1,9+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel]+1,9+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
////                  break; 
//        case 'B': 
//                  tone_period = freqToPeriod(note_freq(cur_octave[channel]+1,11+modif[channel]));
//                  AY_SetReg(rfine[channel],tone_period & 0xff);
//                  AY_SetReg(rcoarse[channel],(tone_period >> 8) & 0xff);
//                  modif[channel] = 0;
//                  nota[channel] = true;
//                  ini_time[channel] = millis();
//                  break; 
////                  AY_set_tone(channel,note_freq(cur_octave[channel]+1,11+modif[channel])); 
////                  AY_config[channel].tone_enabled = true; 
////                  modif[channel] = 0;
////                  nota[channel] = true;
////                  ini_time[channel] = millis();
