...
xst -ifn xst.scr
move clk104_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk104_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk104_exdes.ucf clk104_exdes

echo 'Running map'
map -timing -pr b clk104_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk104_exdes -w routed.ncd routed.v
cd ..
