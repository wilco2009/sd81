...
xst -ifn xst.scr
move clk13_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk13_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk13_exdes.ucf clk13_exdes

echo 'Running map'
map -timing -pr b clk13_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk13_exdes -w routed.ncd routed.v
cd ..
